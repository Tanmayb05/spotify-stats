...
2. Edit `apps/api/.env` and add your credentials:
   ```
...
```bash
cd apps/api
python3 -m jobs.enrich_audio_features
```
...
- Run the enrichment job: `cd apps/api && python3 -m jobs.enrich_audio_features`
