...
class StreamingDataLoader:
    ...
    def __init__(self):
        if not SUPABASE_URL or not SUPABASE_KEY:
            raise ValueError(
                "Missing Supabase credentials. Please set SUPABASE_URL and SUPABASE_SERVICE_KEY in spotify-insights.env"
            )
...
def main():
    ...
    try:
        ...
        print("\n✅ Migration complete!")
        print("\nNext steps:")
        print("1. Update spotify-insights.env.example with Supabase configuration")
